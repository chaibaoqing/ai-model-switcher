...
- **Web 管理界面**：浏览器中切换模型、配置 API Key、查看用量统计
...
向导会引导你完成 API Key 配置、默认模型选择、Codex 连接和开机自启。
...
- 一键切换模型供应商
- 配置 API Key
- 查看用量统计（Token 消耗、请求数、7 天趋势、请求历史）

## CLI 命令

```bash
# 启动代理
codex-model-switcher start
# 或 npm start

# 运行配置向导
codex-model-switcher setup

# 安装开机自启服务
codex-model-switcher install

# 卸载服务
codex-model-switcher uninstall
```
